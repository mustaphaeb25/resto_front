...
export default function FormModal({ isOpen, onClose, onSave, title, children, initialData, loading }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className="relative bg-white rounded-t-2xl sm:rounded-xl shadow-xl w-full sm:max-w-lg max-h-[92dvh] sm:max-h-[85vh] overflow-y-auto animate-fade-in">
        ...
        <form onSubmit={onSave} className="p-5 sm:p-6 space-y-4">
          {children}
